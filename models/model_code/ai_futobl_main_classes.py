...
def main(cfg: DictConfig):
    ...
    #{0: "None", 1: "Player_Detection_Video", 2: "Pitch_Detection_Video", 3: "All_Detection_Video", 4: "Anotatted_Ball_Detection", 5: "Clean Frames"}
    if config.type_of_video in ["Player_Detection_Video", "All_Detection_Video"]:
        full_gen = sv.get_video_frames_generator(config.source_video_path)
        max_frames = 700

        frame_generator = islice(full_gen, max_frames)
        crops = []
